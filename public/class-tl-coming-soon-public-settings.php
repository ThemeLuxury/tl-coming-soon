  ...
  **/
  ...
  { ?><!DOCTYPE html>
        ...
        <head>
          ...
          <!-- Bootstrap Core -->
          <link href="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/css/bootstrap.min.css" rel="stylesheet">
         
          <!-- Font Awesome -->
          <link rel="stylesheet" href="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/fonts/css/all.min.css">

          <!-- Contdown CSS -->
          <link href="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/css/soon.min.css" rel="stylesheet">
          
          <!-- Siding contnent -->
          <link href="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/css/pushy.min.css" rel="stylesheet">
          
          <!-- Main CSS -->
          <link href="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/css/templates/<?php echo isset( get_option('tlcs_template_options')['template'] ) ? get_option('tlcs_template_options')['template'] : 'forest'; ?>.css" rel="stylesheet">
          
          <!-- Main CSS -->
          <link href="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/css/main.css" rel="stylesheet">

          <!-- Media CSS -->
          <link href="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/css/media.css" rel="stylesheet">
        ...
        <body>
          ...
          <!-- Popper core -->
          <script src="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/js/popper.min.js"></script>
          <!-- Bootstrap core -->
          <script src="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/js/bootstrap.min.js"></script>
          <!-- Side content -->
          <script src="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/js/pushy.min.js"></script>
          <!-- Countdown core -->
          <script src="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/js/soon.min.js"></script>
          ...
          <?php if ( get_option('tlcs_design_options')['background']['type'] == 'video' && !empty( get_option('tlcs_design_options')['background']['video'] ) ): ?>
            ...
            <?php if ( $checkVideoType ): ?>
              <!-- EasyBackground core -->
              <script src="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/js/easyBackground.min.js"></script>
              <script>
            ...
            <?php elseif( preg_match('/.*\.mp4.*/', get_option('tlcs_design_options')['background']['video'], $matchMP4 ) ): ?>
              <!-- Bvideo core -->
              <script src="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/js/bideo.min.js"></script>
              <script>
                (function () {
          ...
          <script src="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/js/particles.min.js"></script>
          <script src="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/js/particle-init.min.js"></script>
         
          <?php elseif( !empty( get_option('tlcs_template_options')['template'] ) && get_option('tlcs_template_options')['template'] == 'polygonal' ): ?>

          <script src="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/js/flat-surface-shader.js"></script>
          <script src="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/js/shader.js"></script>

          <?php elseif( !empty( get_option('tlcs_template_options')['template'] ) && get_option('tlcs_template_options')['template'] == '3dbox' ): ?>

          <script src="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/js/Three.js"></script>
          <script src="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/js/Detector.js"></script>
          <script src="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/js/orto.js"></script>
          <script src="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/js/isometric.js"></script>

          <?php elseif( !empty( get_option('tlcs_template_options')['template'] ) && get_option('tlcs_template_options')['template'] == 'pacman' ): ?>

          <script src="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/js/pacman.js"></script>
          <script src="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/js/modernizr.min.js"></script>
          ...
          var onSubscribe = {"url":"http:\/\/wp.local\/plugins\/wp-admin\/admin-ajax.php"};
          </script>

          <script src="<?php echo TL_COMING_SOON_VIEWS_URL; ?>assets/js/subscribe-form.js"></script>
